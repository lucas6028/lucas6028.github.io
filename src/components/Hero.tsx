  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className='text-[#acfffc]'>Hao-Ping</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I'm a student studying Computer Science <br />at the University of Taipei
          </p>
        </div>
      </div>
      <ComputersCanvas />
